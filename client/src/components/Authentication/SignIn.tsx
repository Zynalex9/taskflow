...
const SignIn = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center lg:justify-between">
      ...
      <div className="bg-white p-4 shadow-2xl flex items-center justify-center flex-col gap-2 rounded-2xl">
        ...
        <h3 className="text-center font-charlie-text-r text-heading text-3xl">
          Sign up to Taskflow
        </h3>
        <div className="py-4">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="font-charlie-text-r">
              <label htmlFor="identifier" className="block text-lg my-1">Email or Username</label>
              <input
                type="text"
                id="identifier"
                placeholder="Enter an email or username"
                {...register("loginIdentifier")}
                className="w-[250px] px-2 py-2 rounded border border-black focus:ring-blue-600 focus:ring-2 focus:outline-0"
              />
              {errors.loginIdentifier && <p className="text-xs  mt-0.5 text-red-500">{errors.loginIdentifier.message}</p>}
            </div>
            <div>
              <label htmlFor="password" className="block text-lg my-1">Password</label>
              <input
                type="password"
                id="password"
                ...
                className="w-[250px] px-2 py-2 rounded border border-black focus:ring-blue-600 focus:ring-2 focus:outline-0"
              />
              {errors.password && <p className="text-xs mt-0.5 text-red-500">{errors.password.message}</p>}
