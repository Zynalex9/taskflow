  ...
  return (
    <div className="w-full h-screen flex items-center justify-center lg:justify-between">
      ...
      <div className="bg-white p-4 shadow-2xl flex items-center justify-center flex-col gap-2 rounded-2xl">
        ...
        <div className="py-4">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="font-charlie-text-r">
              <label htmlFor="identifier" className="block text-lg my-1">
                Email or Username
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="password" className="block text-lg my-1">
                Password
              </label>
              <input
                type="password"
        ...
        <h1 className="font-charlie-text-r">
          New to taskflow?
          <Link to={"/user/sign-up"} className="text-blue-primary">
            Register now
          </Link>
        </h1>
